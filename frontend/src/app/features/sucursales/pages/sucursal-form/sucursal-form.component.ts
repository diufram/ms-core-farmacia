                    ...
                    <ng-template pTemplate="header">
                        <div class="px-6 pt-5">
                            ...
                            <p class="text-muted-color text-sm m-0 mt-1">
                                Se creará un usuario con rol admin para esta
                                sucursal.
                            </p>
                        </div>
                    </ng-template>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                        <div>
                            <p-floatlabel variant="on">
                                ...
                                <label for="nombre_admin"
                                    >Nombre del admin *</label
                                >
                            </p-floatlabel>
                            <small
                                *ngIf="invalid('nombre_admin')"
                                class="text-red-500 mt-1 block"
                            >
                        ...
                        <div>
                            <p-floatlabel variant="on">
                                <input
                                    ...
                                    class="w-full"
                                />
                                <label for="apellido_admin"
                                    >Apellido del admin *</label
                                >
                            </p-floatlabel>
                            <small
                                *ngIf="invalid('apellido_admin')"
                                class="text-red-500 mt-1 block"
                            >
                        ...
                        <div>
                            <p-floatlabel variant="on">
                                <input
                                    ...
                                    class="w-full"
                                />
                                <label for="celular_admin"
                                    >Celular del admin</label
                                >
                            </p-floatlabel>
                        </div>
                        ...
                        <div>
                            <p-floatlabel variant="on">
                                <input
                                    ...
                                    class="w-full"
                                />
                                <label for="nombre_usuario_admin"
                                    >Nombre de usuario *</label
                                >
                            </p-floatlabel>
                            <small
                                *ngIf="invalid('nombre_usuario_admin')"
                                class="text-red-500 mt-1 block"
                            >
                                Mínimo 3 caracteres
                            </small>
                        ...
                        <div class="md:col-span-2">
                            <p-floatlabel variant="on">
                                <input
                                    ...
                                    class="w-full"
                                />
                                <label for="correo_admin"
                                    >Correo del admin *</label
                                >
                            </p-floatlabel>
                            <small
                                *ngIf="invalid('correo_admin')"
                                class="text-red-500 mt-1 block"
                            >
                        ...
                        <div class="md:col-span-2">
                            <p-floatlabel variant="on">
                                ...
                                <label for="contrasena_admin"
                                    >Contraseña del admin *</label
                                >
                            </p-floatlabel>
                            <small
                                *ngIf="invalid('contrasena_admin')"
                                class="text-red-500 mt-1 block"
                            >
                                Mínimo 8 caracteres
                            </small>
...
export class SucursalFormComponent implements OnInit {
    ...
    private aplicarValidadoresCreacion(): void {
        ...
        this.form.get('nombre_usuario_admin')!.setValidators([
            Validators.required,
            Validators.minLength(3),
            Validators.maxLength(60),
        ]);
        this.form.get('nombre_usuario_admin')!.updateValueAndValidity();
        this.form.get('correo_admin')!.setValidators([
            Validators.required,
            Validators.email,
        ]);
        this.form.get('correo_admin')!.updateValueAndValidity();
        this.form.get('contrasena_admin')!.setValidators([
            Validators.required,
