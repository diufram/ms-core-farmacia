...
export class CategoriasService {
  ...
  list(sucursalId?: number | null): Observable<Categoria[]> {
    ...
    return this.apollo
      .watchQuery<{ categorias: Categoria[] }, { sucursalId?: number | null }>({
  ...
  create(input: CreateCategoriaInput): Observable<CategoriaPayload> {
    return this.apollo
      .mutate<{ createCategoria: CategoriaPayload }, { input: CreateCategoriaInput }>({
  ...
  update(id: number, input: UpdateCategoriaInput): Observable<Categoria> {
    return this.apollo
      .mutate<{ updateCategoria: Categoria }, { id: number; input: UpdateCategoriaInput }>({
