...
export class UsuariosService {
  ...
  list(filters: UsuariosFilters = {}): Observable<Usuario[]> {
    ...
    return this.apollo
      .watchQuery<{ usuarios: Usuario[] }, { sucursalId?: number | null; rol?: string | null }>({
  ...
  update(id: number, input: UpdateUsuarioInput): Observable<UsuarioPayload> {
    return this.apollo
      .mutate<{ updateUsuario: UsuarioPayload }, { id: number; input: UpdateUsuarioInput }>({
  ...
  assignSucursal(usuarioId: number, input: AssignSucursalInput): Observable<UsuarioPayload> {
    return this.apollo
      .mutate<
  ...
  unassignSucursal(usuarioId: number, sucursalId: number): Observable<UsuarioPayload> {
    return this.apollo
      .mutate<
  ...
  adminResetPassword(id: number, nuevaContrasena: string): Observable<{ message: string }> {
    return this.apollo
      .mutate<
