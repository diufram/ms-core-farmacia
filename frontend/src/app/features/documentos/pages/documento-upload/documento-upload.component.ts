        ...
        <div class="max-w-3xl mx-auto">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted-color m-0 mt-1">
                        Carga archivos al sistema de documentos
                    </p>
                </div>
            </div>
            ...
            <p-card>
                <div class="upload-area">
                    <i
                        class="pi pi-cloud-upload text-5xl text-primary block mb-3"
                    ></i>
                    <h3 class="text-color m-0 mb-2">
                        Arrastra un archivo o haz clic para seleccionar
                    </h3>
                    <p class="text-muted-color m-0 mb-4">
                        Cualquier tipo de archivo (máx. 25 MB)
                    </p>
                ...
                @if (uploading()) {
                    <div class="mt-4">
                        <p-progressBar
                            ...
                            [style]="{ height: '6px' }"
                        />
                        <p class="text-center text-muted-color text-sm mt-2">
                            Subiendo archivo...
                        </p>
                    </div>
                }
    ...
    onUpload(event: FileUploadHandlerEvent): void {
        ...
        this.documentosService.upload(file).subscribe({
            next: (res) => {
                ...
                this.toast.success(
                    `Archivo "${res.filename}" subido correctamente`,
                );
