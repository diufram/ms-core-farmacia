...
export class DocumentosService {
  ...
  upload(file: File): Observable<DocumentoUploadResponse> {
    ...
    return this.http
      .post<DocumentoUploadResponse>(`${this.baseUrl}/upload`, formData)
  ...
  updateFile(id: string, file: File): Observable<DocumentoUploadResponse> {
    ...
    return this.http
      .put<DocumentoUploadResponse>(`${this.baseUrl}/${id}/upload`, formData)
      .pipe(catchError(this.mapError));
  }
  ...
  delete(id: string): Observable<void> {
    return this.http.delete<void>(`${this.baseUrl}/${id}`).pipe(catchError(this.mapError));
  }
