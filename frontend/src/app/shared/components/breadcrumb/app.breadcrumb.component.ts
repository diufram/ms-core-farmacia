...
@Component({
  ...
  template: `
    <div #container class="breadcrumb-container mb-2" *ngIf="items.length > 0">
      <p-breadcrumb [model]="items" [home]="homeItem" styleClass="compact-breadcrumb">
      </p-breadcrumb>
    </div>
  `,
  styles: [
        ...
        .compact-breadcrumb {
          ...
          .p-breadcrumb-list {
            ...
            .p-menuitem-link {
              ...
              .p-menuitem-text {
                font-size: 0.85rem;
                color: var(--text-color-secondary); /* Color base gris */
                white-space: nowrap;
              }
              .p-menuitem-icon {
                color: var(--text-color-secondary);
            ...
            li.active-item .p-menuitem-link {
              ...
              .p-menuitem-text {
                color: var(--text-color) !important; /* Blanco/Negro fuerte */
