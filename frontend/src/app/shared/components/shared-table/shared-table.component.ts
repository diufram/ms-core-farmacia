...
import { TableColumn, RowAction, ActionEvent } from './interfaces/table-config.interface';
...
export class SharedTableComponent {
  ...
  resolveSelectOptions(col: TableColumn, row: any) {
    ...
    return typeof col.selectOptions === 'function' ? col.selectOptions(row) : col.selectOptions;
  }
