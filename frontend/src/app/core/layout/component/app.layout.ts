...
import { MySidebar } from './app.sidebar';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AppTopbar, MySidebar, RouterModule, MyFooter, AppBreadcrumbComponent],
...
export class MainLayout implements OnDestroy {
  ...
  @ViewChild(MySidebar) appSidebar!: MySidebar;
