...
export class Init1779927227442 implements MigrationInterface {
    name = 'Init1779927227442'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."usuarios_sucursal_rol_enum" AS ENUM('admin')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."sucursales_estado_enum" AS ENUM('activa', 'inactiva')`);
        await queryRunner.query(`CREATE TABLE "sucursales" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nombre" character varying(150) NOT NULL, "slug" character varying(160) NOT NULL, "telefono" character varying(20), "correo_electronico" character varying(150), "direccion" character varying(255) NOT NULL, "ciudad" character varying(100), "departamento" character varying(100), "pais" character varying(100), "referencia" character varying(255), "latitud" numeric(10,7), "longitud" numeric(10,7), "logo" character varying(255), "descripcion" text, "estado" "public"."sucursales_estado_enum" NOT NULL DEFAULT 'activa', CONSTRAINT "UQ_c9ff10677e0effcf887ae6499a1" UNIQUE ("slug"), CONSTRAINT "PK_c2232960c9e458db5b18d35eeba" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."clientes_estado_enum" AS ENUM('activo', 'inactivo')`);
        await queryRunner.query(`CREATE TABLE "clientes" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "codigo_cliente" character varying(60) NOT NULL, "telefono_secundario" character varying(20), "observaciones" text, "estado" "public"."clientes_estado_enum" NOT NULL DEFAULT 'activo', "sucursal_id" integer NOT NULL, "persona_id" integer NOT NULL, CONSTRAINT "UQ_clientes_sucursal_persona" UNIQUE ("sucursal_id", "persona_id"), CONSTRAINT "PK_d76bf3571d906e4e86470482c08" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "categorias_producto" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nombre" character varying(120) NOT NULL, "codigo" character varying(160) NOT NULL, "descripcion" text, "activo" boolean NOT NULL DEFAULT true, "sucursal_id" integer NOT NULL, CONSTRAINT "PK_0821d2a56229a0bb8186dab675b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "laboratorios" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "nombre" character varying(140) NOT NULL, "telefono" character varying(20), "correo_electronico" character varying(150), "direccion" character varying(255), "activo" boolean NOT NULL DEFAULT true, "sucursal_id" integer NOT NULL, CONSTRAINT "PK_f3e5296e106c63a9f075157f4bd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."productos_tipo_enum" AS ENUM('medicamento', 'insumo', 'otro')`);
        await queryRunner.query(`CREATE TABLE "productos" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "codigo" character varying(60) NOT NULL, "nombre" character varying(180) NOT NULL, "principio_activo" character varying(120), "presentacion" character varying(80), "tipo" "public"."productos_tipo_enum" NOT NULL DEFAULT 'medicamento', "requiere_receta" boolean NOT NULL DEFAULT false, "stock_actual" integer NOT NULL DEFAULT '0', "stock_minimo" integer NOT NULL DEFAULT '0', "precio_venta" numeric(10,2) NOT NULL DEFAULT '0', "activo" boolean NOT NULL DEFAULT true, "sucursal_id" integer NOT NULL, "categoria_id" integer NOT NULL, "laboratorio_id" integer, CONSTRAINT "UQ_productos_sucursal_codigo" UNIQUE ("sucursal_id", "codigo"), CONSTRAINT "PK_04f604609a0949a7f3b43400766" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "clientes" ADD CONSTRAINT "FK_4efcfe1f3eb48b8c45934d88559" FOREIGN KEY ("sucursal_id") REFERENCES "sucursales"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "laboratorios" ADD CONSTRAINT "FK_53fcb6b1805396d8a60eb278eaa" FOREIGN KEY ("sucursal_id") REFERENCES "sucursales"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "laboratorios" DROP CONSTRAINT "FK_53fcb6b1805396d8a60eb278eaa"`);
        ...
        await queryRunner.query(`ALTER TABLE "clientes" DROP CONSTRAINT "FK_4efcfe1f3eb48b8c45934d88559"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."sucursales_estado_enum"`);
