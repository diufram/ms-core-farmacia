...
export class Init1781138462501 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tokens_dispositivo" ADD CONSTRAINT "FK_5d75d1220f803f28a5374a39e92" FOREIGN KEY ("usuario_id") REFERENCES "usuarios"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "movimientos_stock" ADD CONSTRAINT "FK_af7ee6d27a6567d20176abc4bf7" FOREIGN KEY ("producto_id") REFERENCES "productos"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "movimientos_stock" ADD CONSTRAINT "FK_312f4dff4a1640e1682a61dbb57" FOREIGN KEY ("usuario_id") REFERENCES "usuarios"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "movimientos_stock" DROP CONSTRAINT "FK_312f4dff4a1640e1682a61dbb57"`,
    );
    await queryRunner.query(
      `ALTER TABLE "movimientos_stock" DROP CONSTRAINT "FK_af7ee6d27a6567d20176abc4bf7"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tokens_dispositivo" DROP CONSTRAINT "FK_5d75d1220f803f28a5374a39e92"`,
    );
    await queryRunner.query(
